            ...
            <div className="service-container">
                <div className="service-text">
                    ...
                    <div className="subtitle-container">
                        <h3 className="service-subtitle colored">{data.services.subtitle1}</h3 >
                ...
                <div className="service-cards">
                    {data.services.cardList.map((element, index) => {
                        return <ServiceCard index={index} title={element.title} text={element.text} />
                    })}
                </div>
                <div className="service-quotation">
                    ...
                    <div className="quotation-text-container">
                        ...
                        <p className="quotation-text">
                            {data.services.quotation[0]}
                        </p>
                        <p className="quotation-text">
                            {data.services.quotation[1]}
                        </p>
                    </div>
                </div>
            </div>
